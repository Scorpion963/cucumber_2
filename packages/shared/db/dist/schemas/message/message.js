...
export const message = pgTable("messages", {
    ...
    replyToMessageId: uuid("reply_to_message_id").references(() => message.id, {
        onDelete: "set null",
    }),
    forwardedFromMessageId: uuid("forwarded_from_message_id").references(() => message.id, { onDelete: "set null" }),
    text: text(),
    createdAt,
    updatedAt,
});
